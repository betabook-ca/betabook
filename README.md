...
| `climber13@example.com`                         | Completed tour version 1; gets eight What's new lessons                                                                  |
| `climber14@example.com`                         | Dismissed tour version 1; gets eight What's new lessons                                                                  |
| `climber15@example.com`                         | Completed tour version 2; gets four new Goals lessons                                                                    |
| `climber16@example.com`                         | No tour progress; gets the full thirteen-lesson tour                                                                     |
