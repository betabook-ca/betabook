...
/** Flattens a URLSearchParams into the UrlParamsRecord shape the parse*
...
export function searchParamsToRecord(searchParams: URLSearchParams): UrlParamsRecord {
  const record: UrlParamsRecord = {};
