...
KAYA January 1, 1970 placeholder become undated; an undated ascent of a climb that
has since been marked broken can't be logged and is held at the match step like
any other broken-climb row. Other timestamps use the
